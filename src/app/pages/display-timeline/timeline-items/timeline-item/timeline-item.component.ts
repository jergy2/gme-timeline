...
export class TimelineItemComponent {
  ...
  constructor(
    private _router: Router, private _chartDataService: ChartDataManagerService, private _sizeService: ScreenSizeService, private _itemService: TimelineItemsService) { }
